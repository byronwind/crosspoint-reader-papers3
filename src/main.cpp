...
#elif defined(FREEINK_DEVICE_M5PAPERS3) && FREEINK_DEVICE_M5PAPERS3
...
void loop() {
  ...
  // Poll via the input manager so the on-screen virtual button bar gets its
  // per-frame tap hit-test (plain gpio.update() would skip it).
